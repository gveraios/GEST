...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"media" forKey:@"type"];
...
-(void)volumeUp:(NSNotification*)notification;
{
    ...
    PHControlLightsViewController* rob = [[PHControlLightsViewController alloc]init];
    [rob randomizeColoursOfConnectLights:nil];
...
-(void)volumeDown:(NSNotification*)notification;
{
    ...
    NSString* s = [[NSUserDefaults standardUserDefaults] objectForKey:@"type"];
    if ([s isEqualToString:@"hue"]) {
        PHControlLightsViewController* rob = [[PHControlLightsViewController alloc]init];
        [rob offandon:nil];
        return;
    }
